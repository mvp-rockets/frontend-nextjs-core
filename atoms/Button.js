...
const Button = ({
  ...
  if (style === buttonStyles.link) { modifiedSize = 'p-0' }
  ...
  return (
    <button
      ...
      className={classnames(
        [className],
        "flex items-center disabled:bg-primary-100 disabled:text-primary-300 disabled:outline-none transform transition-transform active:scale-90 duration-300", `${btnRadius} ${fontWeight} ${fontSize} ${fontColor} ${btnClass}`,
        {
          ...
          "w-full": fullWidth,
          "bg-primary-900 text-white hover:bg-primary-800 focus:bg-primary-800 active:bg-primary-800 visited:bg-primary-800":
            style === buttonStyles.primary,
          ...
          "text-primary-900 hover:text-primary-800 focus:text-primary-800 hover:bg-primary-100 focus:bg-primary-100 focus:outline focus:outline-primary-800 focus:outline-2 active:bg-primary-200 visited:bg-primary-200": style === buttonStyles.borderLess,
          "text-primary-900 text-sm outline-0 hover:underline focus:underline active:underline hover:text-primary-800 hover:after:bg-primary-800 focus:text-primary-800  focus:after:bg-primary-800 active:text-primary-800 active:after:bg-primary-800 disabled:bg-transparent disabled:after:bg-primary-300": style === buttonStyles.link,
    ...
    >
      {label && (
        <span className={icon && classnames([className])}> {label} </span>
      )}

      {isLoading ? (<svg className={`${loaderSize ? loaderSize : 'w-5 h-5'} mr-3 -ml-1 ${loaderColor ? loaderColor : 'text-white'} animate-spin`} xmlns="http://www.w3.org/2000/svg" fill="none"
        viewBox="0 0 24 24">
