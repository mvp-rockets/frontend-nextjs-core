...
const InputBox = ({
  ...
  return (
    <div className="relative">
      {isLabel && <label labelfor={labelFor} className={`text-neutral-900 text-base leading-6 font-normal block pb-2 ${labelClass}`}> {labelText} </label>}
      ...
      <input
        ...
        {...{
          className: `${inputStyle[variant]} ${baseClasses} ${disableClass} ${className} ${disabled === true ? "cursor-not-allowed" : "cursor-pointer"} ${isError
