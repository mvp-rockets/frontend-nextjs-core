...
const InputBox = ({
    ...
    baseClasses = "border bg-white rounded-lg outline-none placeholder:text-neutral-400 text-neutral-900 text-base font-normal leading-[21px] appearance-none",
    disabled,
    type = "text",
    register,
    id,
    ...
    return (
        <div className={`relative ${align}`}>
            ...
            <input
                ...
                {...{
                    className: `${inputStyle[variant]} ${inputWidth} ${baseClasses} ${disableClass} ${className} ${disabled === true ? "cursor-not-allowed" : "cursor-pointer"} ${
